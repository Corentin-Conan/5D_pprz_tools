...
Sensor = _reflection.GeneratedProtocolMessageType('Sensor', (_message.Message,), dict(
  ...
  Fused = _reflection.GeneratedProtocolMessageType('Fused', (_message.Message,), dict(
  ...
  PrimaryRadar = _reflection.GeneratedProtocolMessageType('PrimaryRadar', (_message.Message,), dict(
  ...
  SecondaryRadar = _reflection.GeneratedProtocolMessageType('SecondaryRadar', (_message.Message,), dict(
  ...
  Adsb = _reflection.GeneratedProtocolMessageType('Adsb', (_message.Message,), dict(
  ...
  RadioFrequency = _reflection.GeneratedProtocolMessageType('RadioFrequency', (_message.Message,), dict(
  ...
  ElectroOptical = _reflection.GeneratedProtocolMessageType('ElectroOptical', (_message.Message,), dict(
