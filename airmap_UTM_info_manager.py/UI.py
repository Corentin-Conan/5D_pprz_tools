...
class UI(QtWidgets.QWidget):
	...
	def __init__(self):
		...
		self.main_box = QtWidgets.QGroupBox("Information Display Manager")
		...
		self.left_box = QtWidgets.QGroupBox("Info List")
		self.right_box = QtWidgets.QGroupBox("Info Details")
		self.main_box_layout.addWidget(self.left_box)
		self.main_box_layout.addWidget(self.right_box)
