...
def trial1_1_1_init():
	...
	def update_wp_list(msg_id, msg):
		...
		if (None, None) not in coords_wp:
			...
			buffer_cont = line_full_path.buffer(0.0001, resolution = 1, cap_style = 1, join_style = 1)
			buffer_emer = line_full_path.buffer(0.0004, resolution = 1, cap_style = 1, join_style = 1)
			buffer_limit_kill = line_full_path.buffer(0.0008, resolution = 1, cap_style = 1, join_style = 1)
